...
export const PRODUCT_OPTIONS = [
  { id: 1, categoryId: 1, price: 25, duration: 35, stocked: 1, name: 'Espresso' },
  { id: 2, categoryId: 1, price: 30, duration: 40, stocked: 1, name: 'Americano' },
  { id: 3, categoryId: 1, price: 35, duration: 45, stocked: 1, name: 'Latte' },
  { id: 4, categoryId: 2, price: 35, duration: 35, stocked: 1, name: 'Taiwan tea' },
  { id: 5, categoryId: 2, price: 25, duration: 35, stocked: 1, name: 'Thai tea' },
  { id: 6, categoryId: 3, price: 15, duration: 30, stocked: 1, name: 'Soda' },
  { id: 7, categoryId: 3, price: 15, duration: 30, stocked: 1, name: 'Cola' },
  { id: 8, categoryId: 3, price: 20, duration: 30, stocked: 1, name: 'Energy drink' },
];
